...
# Unpack Mocap Data Functions
    ...
    def __unpack_data_descriptions(self, data: bytes, packet_size, major, minor): #type: ignore  # noqa E501
        ...
        # Store the latest parsed data descriptions on the client instance so
        # external code (callbacks) can access rigid body names/IDs for
        # resolution. This is a small, non-invasive convenience addition.
        try:
            # attach attribute to self for callers to inspect
            self.last_data_descriptions = data_descs
        except Exception:
            # If for some reason this cannot be attached, ignore and continue.
            pass
