...
df_sim = LogDecoder.decode_df("examples/webots/robotics/log/fast_log_1765491084.bin")
df_real = LogDecoder.decode_df("examples/webots/robotics/log/fast_log_1765491106.bin")
